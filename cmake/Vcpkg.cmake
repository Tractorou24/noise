...
block()
	#########
	# Helper function used below to check if the vcpkg install is usable
	# _validate_vcpkg_install(
	#   result_var
	#   current_item
	# )
	# An installation is usable if it's not a mount point (or windows vcpkg will be found first on WSL)
	#########
	function(_validate_vcpkg_install result_var item)
		if(item MATCHES "^/mnt")
	...
	find_program(VCPKG_EXECUTABLE vcpkg VALIDATOR _validate_vcpkg_install REQUIRED)
